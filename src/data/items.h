...
// Vitamins
    ...
    {
        .name = _("PP Up"),
        .price = (I_PRICE == GEN_1) ? 1 : ((I_PRICE >= GEN_7) ? 100 : 100),
        .description = COMPOUND_STRING(
            "Raises the maximum\n"
            "PP of a selected\n"
            "move."),
...
// Evolution Items
    ...
    [ITEM_PANCAKES] =
    {
        ...
        .effect = gItemEffect_EvoItem,
        .flingPower = 30,
        .iconPic = gItemIcon_Pancake,
        .iconPalette = gItemIconPalette_Pancake,
    },
