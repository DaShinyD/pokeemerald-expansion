static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_VIRIDIAN_CITY - 1] = {MAP_GROUP(VERIDIAN_CITY), MAP_NUM(VERIDIAN_CITY), 54, 7},
    [HEAL_LOCATION_MOSSDEEP_ROCKET - 1] = {MAP_GROUP(ROCKET_SHIP), MAP_NUM(ROCKET_SHIP), 2, 5},
    [HEAL_LOCATION_VERMILION_CITY - 1] = {MAP_GROUP(VERMILLION_CITY), MAP_NUM(VERMILLION_CITY), 14, 7},
    [HEAL_LOCATION_CERULEAN_CITY - 1] = {MAP_GROUP(CERULEAN_CITY), MAP_NUM(CERULEAN_CITY), 23, 22},
    [HEAL_LOCATION_LAVENDER_TOWN - 1] = {MAP_GROUP(LAVENDER_TOWN), MAP_NUM(LAVENDER_TOWN), 20, 10},
    [HEAL_LOCATION_CELADON_CITY - 1] = {MAP_GROUP(CELADON_CITY), MAP_NUM(CELADON_CITY), 54, 10},
    [HEAL_LOCATION_FUCHSIA_CITY - 1] = {MAP_GROUP(FUCHSIA_CITY), MAP_NUM(FUCHSIA_CITY), 21, 32},
    [HEAL_LOCATION_SAFFRON_CITY - 1] = {MAP_GROUP(SAFFRON_CITY), MAP_NUM(SAFFRON_CITY), 28, 42},
    [HEAL_LOCATION_PEWTER_CITY - 1] = {MAP_GROUP(PEWTER_CITY), MAP_NUM(PEWTER_CITY), 15, 31},
};
