...
const u32 gItemIcon_MegaCandy[] = INCBIN_U32("graphics/items/icons/mega_candy.4bpp.lz");
const u32 gItemIconPalette_MegaCandy[] = INCBIN_U32("graphics/items/icon_palettes/mega_candy.gbapal.lz");
