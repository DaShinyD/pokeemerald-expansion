...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_STRATAGRUNT, gTrainerFrontPic_StrataGrunt, gTrainerPalette_StrataGrunt),
    TRAINER_SPRITE(TRAINER_PIC_STRATALEADER, gTrainerFrontPic_StrataLeader, gTrainerPalette_StrataLeader),
