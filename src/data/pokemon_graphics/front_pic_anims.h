...
static const union AnimCmd sAnim_Darg_1[] =
{
    ANIMCMD_FRAME(0, 30),
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 1),
...
static const union AnimCmd sAnim_Dargo_1[] =
{
    ANIMCMD_FRAME(0, 30),
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 1),
...
static const union AnimCmd sAnim_Dargon_1[] =
{
    ANIMCMD_FRAME(0, 30),
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 1),
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Aquar);

PLACEHOLDER_ANIM_SINGLE_FRAME(Aquaria);

PLACEHOLDER_ANIM_SINGLE_FRAME(Aquarius);

PLACEHOLDER_ANIM_SINGLE_FRAME(CrystalOnix);

PLACEHOLDER_ANIM_SINGLE_FRAME(CrystalSteelix);

PLACEHOLDER_ANIM_SINGLE_FRAME(Deliclaus);

PLACEHOLDER_ANIM_SINGLE_FRAME(Dialkia);

PLACEHOLDER_ANIM_SINGLE_FRAME(Insecteon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Mysteon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Brawleon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Wispeon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Bouldeon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Vexeon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Omneon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Toxeon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Anceon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Metalleon);

PLACEHOLDER_ANIM_SINGLE_FRAME(Aereon);

PLACEHOLDER_ANIM_SINGLE_FRAME(FakeGroudon);

PLACEHOLDER_ANIM_SINGLE_FRAME(AbraH);

PLACEHOLDER_ANIM_SINGLE_FRAME(KadabraH);

PLACEHOLDER_ANIM_SINGLE_FRAME(AlakazamH);

PLACEHOLDER_ANIM_SINGLE_FRAME(BulbasaurH);

PLACEHOLDER_ANIM_SINGLE_FRAME(IvysaurH);

PLACEHOLDER_ANIM_SINGLE_FRAME(VenusaurH);

PLACEHOLDER_ANIM_SINGLE_FRAME(MudkipH);

PLACEHOLDER_ANIM_SINGLE_FRAME(MarshtompH);

PLACEHOLDER_ANIM_SINGLE_FRAME(SwampertH);

PLACEHOLDER_ANIM_SINGLE_FRAME(PidgeyH);

PLACEHOLDER_ANIM_SINGLE_FRAME(PidgeottoH);

PLACEHOLDER_ANIM_SINGLE_FRAME(PidgeotH);

PLACEHOLDER_ANIM_SINGLE_FRAME(Gorochu);

PLACEHOLDER_ANIM_SINGLE_FRAME(Helix);

PLACEHOLDER_ANIM_SINGLE_FRAME(NumelH);

PLACEHOLDER_ANIM_SINGLE_FRAME(CameruptH);

PLACEHOLDER_ANIM_SINGLE_FRAME(PonytaH);

PLACEHOLDER_ANIM_SINGLE_FRAME(RapidashH);

PLACEHOLDER_ANIM_SINGLE_FRAME(Kingkarp);

PLACEHOLDER_ANIM_SINGLE_FRAME(GyaradosH);

PLACEHOLDER_ANIM_SINGLE_FRAME(MiloticH);

PLACEHOLDER_ANIM_SINGLE_FRAME(Policroak);

PLACEHOLDER_ANIM_SINGLE_FRAME(Regialpha);

PLACEHOLDER_ANIM_SINGLE_FRAME(ShuckleH);

PLACEHOLDER_ANIM_SINGLE_FRAME(UnownGod);

PLACEHOLDER_ANIM_SINGLE_FRAME(GrowlitheH);

PLACEHOLDER_ANIM_SINGLE_FRAME(ArcanineH);

PLACEHOLDER_ANIM_SINGLE_FRAME(Slifer);
...
SINGLE_ANIMATION(Aquar);
SINGLE_ANIMATION(Aquaria);
SINGLE_ANIMATION(Aquarius);
SINGLE_ANIMATION(CrystalOnix);
SINGLE_ANIMATION(CrystalSteelix);
SINGLE_ANIMATION(Deliclaus);
SINGLE_ANIMATION(Dialkia);
SINGLE_ANIMATION(Insecteon);
SINGLE_ANIMATION(Mysteon);
SINGLE_ANIMATION(Brawleon);
SINGLE_ANIMATION(Aereon);
SINGLE_ANIMATION(Wispeon);
SINGLE_ANIMATION(Vexeon);
SINGLE_ANIMATION(Omneon);
SINGLE_ANIMATION(Anceon);
SINGLE_ANIMATION(Toxeon);
SINGLE_ANIMATION(Bouldeon);
SINGLE_ANIMATION(Metalleon);
SINGLE_ANIMATION(Darg);
SINGLE_ANIMATION(Dargo);
SINGLE_ANIMATION(Dargon);
SINGLE_ANIMATION(FakeGroudon);
SINGLE_ANIMATION(AbraH);
SINGLE_ANIMATION(KadabraH);
SINGLE_ANIMATION(AlakazamH);
SINGLE_ANIMATION(BulbasaurH);
SINGLE_ANIMATION(IvysaurH);
SINGLE_ANIMATION(VenusaurH);
SINGLE_ANIMATION(MudkipH);
SINGLE_ANIMATION(MarshtompH);
SINGLE_ANIMATION(SwampertH);
SINGLE_ANIMATION(PidgeyH);
SINGLE_ANIMATION(PidgeottoH);
SINGLE_ANIMATION(PidgeotH);
SINGLE_ANIMATION(Gorochu);
SINGLE_ANIMATION(Helix);
SINGLE_ANIMATION(NumelH);
SINGLE_ANIMATION(CameruptH);
SINGLE_ANIMATION(PonytaH);
SINGLE_ANIMATION(RapidashH);
SINGLE_ANIMATION(Kingkarp);
SINGLE_ANIMATION(GyaradosH);
SINGLE_ANIMATION(MiloticH);
SINGLE_ANIMATION(Policroak);
SINGLE_ANIMATION(Regialpha);
SINGLE_ANIMATION(ShadowLugia);
SINGLE_ANIMATION(ShuckleH);
SINGLE_ANIMATION(UnownGod);
SINGLE_ANIMATION(GrowlitheH);
SINGLE_ANIMATION(ArcanineH);
SINGLE_ANIMATION(Slifer);
