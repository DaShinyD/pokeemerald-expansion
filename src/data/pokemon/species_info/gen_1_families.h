...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_METAPOD}),
    },
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_BUTTERFREE}),
    },
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_KAKUNA}),
    },
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_BEEDRILL}),
    },
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                {EVO_ITEM, ITEM_PANCAKES, SPECIES_RAICHU_ALOLA}),
    },
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    {
        .baseHP        = 85,
        .baseAttack    = P_UPDATED_STATS >= GEN_6 ? 115 : 92,
        .baseDefense   = 80,
        .baseSpeed     = 105,
        .baseSpAttack  = 85,
        .baseSpDefense = 75,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_EARLY_BIRD, ABILITY_MULTITASKER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CLOYSTER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_ICE_STONE, SPECIES_GLACISTER}),
    },
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_FOREWARN, ABILITY_PSYCHIC_CORE },
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_NONE, ABILITY_INNER_FOCUS },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MAROWAK},
                                {EVO_ITEM, ITEM_PANCAKES, SPECIES_MAROWAK_ALOLA},
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_ATK_LT_DEF, 20, SPECIES_HITMONCHAN},
                                ...
                                {EVO_LEVEL_SPATK_GT_ATK_AND_DEF, 20, SPECIES_HITMONKAME},
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_KEEN_EYE, ABILITY_IRON_FIST, ABILITY_JAB_MASTER },
    #else
    ...
    [SPECIES_BLISSEY] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 30,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 999 : 255,
    ...
    [SPECIES_JYNX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_ICE_STONE, SPECIES_SOPRANICE}),
    },
#endif //P_FAMILY_JYNX
