...
static const u32 sDerekScreenshotsTiles[] = INCBIN_U32("graphics/ui_screenshots/derek_tiles.8bpp");
static const u32 sDerekScreenshotsTilemap[] = INCBIN_U32("graphics/ui_screenshots/derek_tiles.bin");
static const u16 sDerekScreenshotsPalette[] = INCBIN_U16("graphics/ui_screenshots/derek_tiles.gbapal");
...
static const struct Screenshot sScreenshotData[] = {
    [SCREENSHOT_DEREK] = {
        .screenshotTiles = sDerekScreenshotsTiles,
        .screenshotTilemap = sDerekScreenshotsTilemap,
        .screenshotPalette = sDerekScreenshotsPalette,
    },
};
