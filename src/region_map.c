...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_VIRIDIAN_CITY] = {MAP_GROUP(VERIDIAN_CITY), MAP_NUM(VERIDIAN_CITY), HEAL_LOCATION_VIRIDIAN_CITY},
    [MAPSEC_MOSSDEEP_ROCKET] = {MAP_GROUP(ROCKET_SHIP), MAP_NUM(ROCKET_SHIP), HEAL_LOCATION_MOSSDEEP_ROCKET},
    [MAPSEC_VERMILION_CITY] = {MAP_GROUP(VERMILLION_CITY), MAP_NUM(VERMILLION_CITY), HEAL_LOCATION_VERMILION_CITY},
