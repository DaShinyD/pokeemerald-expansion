...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTLEMAN"), 80, BALL_LUXURY },
    ...
    [TRAINER_CLASS_MASTER]        = { _("{PKMN} MASTER"), 0, BALL_LUXURY },
    [TRAINER_CLASS_TEAM_STRATA]   = { _("TEAM STRATA"), 20 },
    [TRAINER_CLASS_STRATA_LEADER] = { _("STRATA LEAD"), 30 },
    [TRAINER_CLASS_TEAM_ROCKET]   = { _("TEAM ROCKET"), 20 },
    [TRAINER_CLASS_MOB_BOSS]      = { _("MOB BOSS"), 30, BALL_MOON },
    [TRAINER_CLASS_DUELIST]       = { _("DUELIST"), 0, BALL_MASTER },
};
