...
STATIC_ASSERT(MAX_LEVEL <= 150, PokemonSubstruct0_experience_PotentiallTooSmall); // Maximum of ~16 million exp.
...
STATIC_ASSERT(MAX_LEVEL <= 150, PokemonSubstruct3_metLevel_TooSmall);
