...
#define FRIENDSHIP_EVO_THRESHOLD ((P_FRIENDSHIP_EVO_THRESHOLD >= GEN_9) ? 120 : 120)
...
static const struct SpriteTemplate sTrainerBackSpriteTemplates[] =
{
    ...
    [TRAINER_BACK_PIC_DASH] = {
        .tileTag = TAG_NONE,
        .paletteTag = 0,
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Dash,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
};
...
STATIC_ASSERT(MAX_LEVEL <= 200, PokemonSubstruct0_experience_PotentiallTooSmall); // Maximum of ~32 million exp.
...
STATIC_ASSERT(MAX_LEVEL <= 200, PokemonSubstruct3_metLevel_TooSmall);
