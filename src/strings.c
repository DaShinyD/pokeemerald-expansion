...
const u8 gText_Vermillion[] = _("VERMILION");
const u8 gText_Vermilion[] = _("VERMILION");
const u8 gText_Cerulean[]  = _("CERULEAN");
const u8 gText_Pewter[]    = _("PEWTER");
const u8 gText_Viridian[]  = _("VIRIDIAN");
const u8 gText_Pallet[]    = _("PALLET");
const u8 gText_Lavender[]  = _("LAVENDER");
const u8 gText_Saffron[]   = _("SAFFRON");
const u8 gText_Celadon[]   = _("CELADON");
const u8 gText_Fuchsia[]   = _("FUCHSIA");
const u8 gText_Cinnabar[]  = _("CINNABAR");
...
const u8 gText_TrainerCardLevelCap[] = _("LVL CAP");
const u8 gText_NewLevelCapIs[] = _("The new level cap is {STR_VAR_1}.$");
