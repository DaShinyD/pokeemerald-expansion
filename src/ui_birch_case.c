...
{
    [BALL_TOP_FIRST]        = {SPECIES_MUDKIP, 5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
    [BALL_TOP_SECOND]       = {SPECIES_TREECKO, 5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TORCHIC, 5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},

    [BALL_TOP_THIRD]        = {SPECIES_CHIKORITA, 5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
    [BALL_TOP_FOURTH]       = {SPECIES_TOTODILE, 5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
    [BALL_MIDDLE_THIRD]     = {SPECIES_CYNDAQUIL, 5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
