...
static const struct MonChoiceData sStarterChoicesSets[STARTER_SET_COUNT][9] =
{
    ...
    // ===== SET 4 =====
    {
        [BALL_TOP_FIRST]        = {SPECIES_BULBASAUR_HOENNIAN,  5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
        [BALL_TOP_SECOND]       = {SPECIES_PIPLUP_HOENNIAN,  5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
        [BALL_MIDDLE_FIRST]     = {SPECIES_PAWNIARD_HOENNIAN,   5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},

        [BALL_TOP_THIRD]        = {SPECIES_BELDUM_HOENNIAN,5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
        [BALL_TOP_FOURTH]       = {SPECIES_LARVITAR_HOENNIAN,5,ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
        [BALL_MIDDLE_THIRD]     = {SPECIES_SEEL_HOENNIAN, 5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},

        [BALL_MIDDLE_SECOND]    = {SPECIES_GIBLE_HOENNIAN,5, ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
        [BALL_BOTTOM_FIRST]     = {SPECIES_SLOWCALF,5,ITEM_NONE, ITEM_POKE_BALL, 26, 0, 4, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}},
