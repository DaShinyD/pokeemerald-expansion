...
#define METATILE_Facility_Grave_Normal                  0x325
...
#define METATILE_General_RockMountainPath        0x071
#define METATILE_General_RockOnRock_Corner_L     0x09B
#define METATILE_General_RockOnRock_Corner_LT    0x06B
#define METATILE_General_RockOnRock_Corner_R     0x09C
#define METATILE_General_RockOnRock_Corner_RT    0x06D
#define METATILE_General_RockWall_GrassBase      0x079
#define METATILE_General_RockWall_RockBase       0x07C
#define METATILE_General_RockWall_RockSideLeft   0x073
#define METATILE_General_RockWall_RockSideRight  0x075
#define METATILE_General_RockWall_RockTop        0x06C
