...
#define BATTLE_TYPE_SCRIPTED_DASH_RYE  BATTLE_TYPE_28
...
#define BATTLE_ENVIRONMENT_BEACH            22
#define BATTLE_ENVIRONMENT_SPACEME          23
#define BATTLE_ENVIRONMENT_TOURNAMENT       24
