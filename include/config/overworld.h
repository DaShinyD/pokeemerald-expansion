...
#define OW_FLAG_NO_COLLISION        FLAG_NO_COLLIDE  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
